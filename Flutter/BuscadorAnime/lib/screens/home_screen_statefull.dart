...
class _HomeScreenStatefullState extends State<HomeScreenStatefull> {
  ...
  incrementarContador(counter){
    setState(() {
      counter++;
    });
  }

  decrementarContador(counter){
    setState(() {
      counter++;
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: BarraSuperior(
        tituloBarra: 'HomeScreenStatefull',
      ), // AppBar
      body: BodyContador(counter: counter),
      floatingActionButton: BotonFlotante(subirContador: subirContador,),
    );
  }
...
class BotonFlotante extends StatelessWidget {
  final Function subirContador;
  const BotonFlotante({
    Key? key, required this.subirContador,
  }) : super(key: key);
...
class BarraSuperior extends StatelessWidget with PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      title: Center(child: Text(tituloBarra)),
      elevation: 15,
    );
  }
...
class BodyContador extends StatefulWidget {
  const BodyContador({
    Key? key,
  ...
  @override
  State<BodyContador> createState() => _BodyContadorState();
}

class _BodyContadorState extends State<BodyContador> {
  @override
  Widget build(BuildContext context) {
    return Center(
      child: Column(
...
Future<List<Map<String, dynamic>>> recuperarAnimes() async {
  final response = await http
      .get(Uri.parse('https://api.jikan.moe/v4/anime?q=&status=&type=&'
  ...
  return [
    {
      ...
      "images": {
        ...
        "webp": {
          "image_url":
          "https://cdn.myanimelist.net/images/anime/1517/100633.webp",
          "small_image_url":
      ...
      "trailer": {
        ...
        "images": {
          ...
          "small_image_url":
          "https://img.youtube.com/vi/hKHepjfj5Tw/sddefault.jpg",
          "medium_image_url":
          "https://img.youtube.com/vi/hKHepjfj5Tw/mqdefault.jpg",
          "large_image_url":
          "https://img.youtube.com/vi/hKHepjfj5Tw/hqdefault.jpg",
          "maximum_image_url":
      ...
      "aired": {
        ...
        "prop": {
          "from": {"day": 29, "month": 4, "year": 2019},
          "to": {"day": 1, "month": 7, "year": 2019}
        },
      ...
      "producers": [
        ...
        },
        {
          ...
          "url":
          "https://myanimelist.net/anime/producer/1557/Pony_Canyon_Enterprise"
        }
      ],
      "licensors": [
        {
    ...
    },
    {
      ...
      "aired": {
        ...
        "prop": {
          "from": {"day": 8, "month": 4, "year": 2015},
          "to": {"day": 30, "month": 3, "year": 2016}
        },
    ...
    },
    {
      ...
      "aired": {
        ...
        "prop": {
          "from": {"day": 4, "month": 4, "year": 2011},
          "to": {"day": 26, "month": 3, "year": 2012}
        },
      ...
      "background":
      "This is the second season of Gintama. In the episode continuity corresponds to episodes 202-252 of Gintama.",
      "season": "spring",
      "year": 2011,
      "broadcast": {
        "day": "Mondays",
